/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a965726b2e3d89b1967ac41a48efd39a)
// Runtime types generated with workerd@1.20260918.1 2026-09-08 global_fetch_strictly_public
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	DB: D1Database;
	ARGON2_ENDPOINT: SecretsStoreSecret;
	ARGON2_HMAC_SECRET: SecretsStoreSecret;
	VERCEL_PROTECTION_BYPASS: SecretsStoreSecret;
	TURNSTILE_SECRET: SecretsStoreSecret;
	AUTH_IP_RATE_LIMIT: RateLimit;
	AUTH_SLUG_RATE_LIMIT: RateLimit;
